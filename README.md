...
1) Install the latest Nvidia driver for your graphic device
2) [Install Nvidia CUDA Toolkit 11.0](https://developer.nvidia.com/cuda-downloads) (must be installed add a hardware driver for cuda support)
3) [Download Nvidia cuDNN v8.0.5 for CUDA 11.0](https://developer.nvidia.com/rdp/cudnn-download)
